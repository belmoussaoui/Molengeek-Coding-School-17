...
<header id="header" class="fixed-top bg-transparent border-0">
    ...
    <h1 class="logo"><a href="index.html">About Section Edit</a></h1>
...
<div class="container mt-5">
        ...
        <div class="row mt-2 pt-5">
            <div class="col-2"></div>
            <div class="col-8">
                    <form id='form-edit' action={{ route('about.update', $about) }} method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label class="form-label">Title</label>
                            <input type="text" class="form-control" name="title" value="{{$about->section->title}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Text</label>
                            <input type="text" class="form-control" name="text" value="{{$about->section->text}}">
                        </div>
                        <div class="mb-3">
