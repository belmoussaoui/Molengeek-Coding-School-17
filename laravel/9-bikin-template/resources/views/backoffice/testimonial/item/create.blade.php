...
<header id="header" class="fixed-top bg-transparent border-0">
    ...
    <nav id="navbar" class="navbar">
        <ul>
            ...
            <li><a class="getstarted mx-2" href="{{ route('testimonial-items.index') }}">Back</a></li>
...
<div class="container mt-5">
        ...
        <div class="row mt-2 pt-5">
            <div class="col-2"></div>
            <div class="col-8">
                    <form id='form-edit' action={{ route('testimonial-items.store') }} method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
