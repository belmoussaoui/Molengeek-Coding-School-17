...
-   admin = williams@test.com
-   webmaster = jones@test.com
-   redactor = miller@test.com
...
-   menu navbar éditable
-   section home éditable et création des carrousels images
-   3 services aléatoires front
-   la section about éditable
-   la section testimonials éditables et création de testimonial
-   la section services éditables et création de service
-   la section features éditables et création de feature
-   la section contact et formulaire de contact
-   la section footer
-   la section team et les utilisateurs
-   l'enregistrement de comptes et admin
-   la newsletter
-   le système de blog
    -   création d'articles
    ...
    -   la recherche du post
-   le backoffice avec accès limité
...
-   changer le logo (change aussi celle de la navbar)
...
-   redacteur peut voir les articles dans le backoffice
