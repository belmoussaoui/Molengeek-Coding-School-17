...
<div class="page-top-section">
    <div class="text-right">
			<div class="page-info">
				...
				<div class="page-links">
                    ...
                    <a class="not-after" href="{{ route("feature-items.index") }}"><span>Features Item</span></a>
				</div>
			</div>
		</div>
	</div>
    ...
    <form class="form-class" action="{{ route("feature-items.store") }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
