...
@section('content')
		...
		<div class="text-right">
			<div class="page-info">
				...
				<div class="page-links">
                    ...
                    <a class="not-after" href="{{ route("service-items.index") }}"><span>Sliders</span></a>
				</div>
			</div>
		</div>
	</div>
    <div class="section-title">
        <h2>Service Items</h2>
        <a href="{{ route('service-items.create') }}" style="margin-top: 30px" class="site-btn">Add</a>
    </div>
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6 mb-2">
            ...
            <div class="lab-card" >
                ...
                <p>{{ $item->text }}</p>
                <div class="d-flex">
                        <a class="site-btn btn-2 side mb-1" href="{{ route('service-items.edit', $item) }}">Edit</a>
                        <form style="display: inline;" action={{ route('service-items.destroy', $item) }} method="post">
                            @csrf
                            @method('delete')
