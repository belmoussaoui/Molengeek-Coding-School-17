...
let r2 = "parseint";
let score = Number(r1 == q1.toLowerCase()) + Number(r2 == q2.toLowerCase());
...
if (isNaN(age))
    console.log("Vu que vous ne savez pas lire une instruction, je présume que vous n'avez pas l'âge.");
else if (age < 0)
    console.log("Revenez quand vous serez né !");
else if (age === 18)
    console.log("Réservez mais attention, c'est tout juste et ce film peut être choquant !");
else if (age > 18)
    console.log("vous êtes majeur, vous pouvez réserver.");
else
    console.log("vous êtes mineur, revenez plus tard.");
// 11
...
if (!res1)
    console.log("Pas de problème, ne partez pas en vacances.");
if (!res2 || res3)
    console.log("Même si vous le vouliez, vous ne pouriez pas partir...");
if (res2 || !res3)
    console.log("Vous pourriez partir en vacance si vous le vouliez.");
if (res1 && res2 && !res3)
