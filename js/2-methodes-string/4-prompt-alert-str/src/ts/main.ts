const prenom : string = prompt("Quel est ton prénom");

const charToUpperCase = (word: string, pos: number): string => {
...
// 5
let pos : number = prenom.indexOf(prompt("Quelle lettre tu veux mettre en majuscule?")) || 0;
